...
namespace services.Services
{
    ...
    public interface IUserConferenceService
    {
        ...
        /// </summary>
        ConferenceDTO AddConference(int idUser, Model.DTOModels.ConferenceDTO conferenceDTO);
        ...
        /// </summary>
        IEnumerable<Model.DTOModels.ConferenceDTO> GetRelevantConferences(int idUser, UserRole userRole);

        /// <summary>
        /// Used for getting a list of conferences for a specific user NO MATTER THE ROLE.
        /// Gets the conferences in wich the user is participating, and has a specific role.
        /// </summary>
        IEnumerable<Model.DTOModels.ConferenceDTO> GetRelevantConferences(int idUser);

        /// <summary>
        /// Gets all the ACCEPTED Conferences
        /// </summary>
        IEnumerable<Model.DTOModels.ConferenceDTO> GetAllConferences();
        ...
        /// </summary>
        ConferenceDTO ModifyDescription(int idUser, Model.DTOModels.ConferenceDTO conferenceDTO);
